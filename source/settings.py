...
class Settings():
    ...
    def __init__(self):
        ...
        self.jumping_mario_images = [pygame.image.load(os.path.join('assets/images', 'mario-' + str(x) + '.png')) for x in range(8,16)]
        self.running_mario_images = [pygame.image.load(os.path.join('assets/images', 'mario-' + str(x) + '.png')) for x in range(1,3)]
